...
import { ProjectMemberUncheckedUpdateManyWithoutProjectNestedInput } from '../project-member/project-member-unchecked-update-many-without-project-nested.input';
...
export class ProjectUncheckedUpdateInput {
    ...
    @Field(() => ProjectMemberUncheckedUpdateManyWithoutProjectNestedInput, {nullable:true})
